...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Integration of Research Findings](https://danilofreire.github.io/datasci385/lectures/lecture-24/24-meta-analysis.html)"
transition: slide
...
# The challenge of generalisation 🤔 {background-color="#1B3A6B"}
...
# Estimating population average treatment effects (PATE) 🌎 {background-color="#1B3A6B"}
...
# A Bayesian framework for interpretation 📈 {background-color="#1B3A6B"}
...
# Meta-Analysis 📊 {background-color="#1B3A6B"}
...
# Case study: Legislature size and government spending 💰 {background-color="#1B3A6B"}
