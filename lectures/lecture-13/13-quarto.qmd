...
subtitle: Lecture 13 - Introduction to Quarto and DeclareDesign
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Quarto and DD](https://danilofreire.github.io/datasci385/lectures/lecture-13/13-quarto.html)"
transition: slide
...
- [Adaptive research designs]{.alert} that maximise benefits and minimise harm
:::
...
# Quarto 📝 {background-color="#1B3A6B"}
...
# Writing a Quarto document 📝 {background-color="#1B3A6B"}
...
# Quarto engines {background-color="#1B3A6B"}
...
- The key is the first line of the reference in the `.bib` file (e.g., `@article{nash1950equilibrium,...}`). The key here is `nash1950equilibrium`
...
# DeclareDesign 📊 {background-color="#1B3A6B"}
...
- The great thing about DeclareDesign is that you can simulate [any kind of design]{.alert} you can think of (e.g., experiments, regression discontinuity, difference-in-differences, even qualitative research!)
...
# DesignLibrary 📚 {background-color="#1B3A6B"}
...
# DesignWizard 🧙 {background-color="#1B3A6B"}
...
:::{.columns}
:::{.column width="40%"}
- Our friends at DeclareDesign have created a tool called [DesignWizard](https://eos.wzb.eu/ipi/DDWizard/) that can help you create and diagnose designs interactively
- It's a great way to get started with DeclareDesign [without writing any code!]{.alert}
- DesignWizard asks a few questions about your research goals and then generates the corresponding DeclareDesign code for you
- It even generates the simulations and diagnoses for you automatically!
- [Give it a try!]{.alert} 🧙
:::

:::{.column width="60%"}
:::{style="text-align: center;"}
![](figures/designwizard.png){width=90%}
...
- If you want to dive deeper into the MIDA framework, please read chapters 5–13 here: <https://book.declaredesign.org/declaration-diagnosis-redesign/declaring-designs.html>
