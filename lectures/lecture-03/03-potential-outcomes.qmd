...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Potential Outcomes](https://danilofreire.github.io/datasci385/lectures/lecture-03/03-potential-outcomes.html)"
transition: slide
...
# Hello, everyone! 👋 <br> Hope you're all doing well! 😉 {background-color="#1B3A6B"}
...
# Do hospitals make people sicker? 🏥 {background-color="#1B3A6B"}
...
# The experimental ideal 👩🏻‍🔬 {background-color="#1B3A6B"}
...
# Recap: back to our hospital example 🏥 {background-color="#1B3A6B"}
...
# Thank you for your attention! 🙏 <br> See you all soon! 😊 {background-color="#1B3A6B"}