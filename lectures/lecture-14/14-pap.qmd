...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[PAPs](https://danilofreire.github.io/datasci385/lectures/lecture-14/14-pap.html)"
transition: slide
...
- We will talk about their components
  - Research questions, hypotheses, variables, estimation, threats to validity
...
# The brief history of PAPs 📜 {background-color="#1B3A6B"}
...
- While RCTs have been around for decades, the first PAPs were written in the early 2000s in response to a [growing concern about false results in medicine]{.alert}
- In 1997, the U.S. Food and Drug Administration Modernization Act (FDAMA) mandated the public registration of clinical trials, [including protocols for data collection and analysis]{.alert}
...
- As you might expect, these [statistical analysis plans (SAPs)]{.alert} were designed to prevent data mining and selective reporting
...
![](figures/ofosu.png){width=90%}
 ...
 More than 50 hypotheses specified? Really? How can this prevent data mining?
...
- [People can steal your work]{.alert}: This seems to be of little concern, as only 15% of respondents said they cared about this
:::

## SOPs as a flexible alternative to PAPs?

:::{style="margin-top: 30px; font-size: 27px;"}
- [Lin and Green (2016)](https://www.stat.berkeley.edu/~winston/sop-safety-net.pdf) argue that we should adopt an SOP as much as possible to avoid the pitfalls of PAPs
...
- They can save time if you work in a research group, as you can share the same SOP with your colleagues and avoid writing multiple PAPs
...
# Components of a PAP 📝 {background-color="#1B3A6B"}
...
- At the minimum, PAPs should include [4 sections]{.alert}:
...
- Available at <https://danilofreire.github.io/datasci385/design-form.html>
:::
...
|                   | and/or magnitude are predicted by the primary    |
...
|                   | the intervention?                                |
|                   | ii. If the intervention is a programme, how much |
|                   | does someone need to attend (showing up once?    |
|                   | finishing the programme?) in order to count as   |
|                   | having attended?                                 |
+-------------------+--------------------------------------------------+
...
|                   | how will you find the same respondents (minimise |
|                   | attrition?)                                      |
+-------------------+--------------------------------------------------+
...
|                   | you randomise at the individual level?           |
+-------------------+--------------------------------------------------+
:::
...
|                   | including enumerators? How will you minimise     |
|                   | them?                                            |
...
# PAP examples you can use 📝 {background-color="#1B3A6B"}
...
# Dates for your PAPs 📅 {background-color="#1B3A6B"}

## Important dates (tentative)

:::{style="margin-top: 30px; font-size: 34px;"}
- [Wednesday, November 5th]{.alert}: Pre-analysis plan due
- [Wednesday, November 12th]{.alert}: Feedback on your PAP
- [Monday, November 17th]{.alert}: Simulated data based on your PAP
- [Monday, December 1st]{.alert}: Final report due
- [Wednesday, December 3rd]{.alert}: Presentations
- [Monday, December 8th]{.alert}: Presentations
:::

# And that's all for today! 🎉 {background-color="#1B3A6B"}

# Have a great week! 🎉 {background-color="#1B3A6B"}