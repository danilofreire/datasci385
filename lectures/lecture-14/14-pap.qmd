...
- [Ofosu and Posner (2021)](https://www.cambridge.org/core/journals/perspectives-on-politics/article/preanalysis-plans-an-early-stocktaking/94E7FAE76001C45A04E8F5E272C773CE) mention some of the main criticisms:
  ...
  - Finally, [PAPs don't actually work]{.alert}, as they require constant policing and this is something academia does not reward
:::
...
More than 50 hypothesis specified? How can this prevent data mining?
...
- With the members of your group, try to fill out the following sections
- You don't need to fill out all the details, just a brief summary of each section
- You have a few minutes to discuss each part of the template with your colleages, then we can discuss them together
...
# Examples of PAPs 📊 {background-color="#2d4563"}
...
- Wednesday, March 26: PAP draft due (about 10 pages)
