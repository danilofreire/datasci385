...
- [Cost-Effectiveness Analysis]{.alert}:
    ...
    - Face-to-face mobilization significantly more cost-effective
:::
...
- [Supports Hypothesis]{.alert}: Personal canvassing > impersonal methods for turnout
    - Decline in face-to-face mobilization may contribute to turnout decline
...
- [Highlights importance of *personal* connection]{.alert} in political mobilization
- [Methodological Contribution]{.alert}:
