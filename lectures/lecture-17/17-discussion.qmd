...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Discussion](https://danilofreire.github.io/datasci385/lectures/lecture-17/17-discussion.html)"
transition: slide
...
# Olá! How are you doing? 😊 {background-color="#1B3A6B"}
...
# Discussion 💬 {background-color="#1B3A6B"}
