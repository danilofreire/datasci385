...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Blocking and Clustering](https://danilofreire.github.io/datasci385/lectures/lecture-07/07-blocking.html)"
transition: slide
...
# Blocking and Clustering {background-color="#1B3A6B"}
...
# Clustering {background-color="#1B3A6B"}
