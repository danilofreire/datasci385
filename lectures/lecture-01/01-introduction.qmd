---
title: "Welcome to DATASCI 385 - Experimental Methods"
...
format:
  clean-revealjs:
    self-contained: true
    footer: "[Introduction](https://danilofreire.github.io/datasci385/lectures/lecture-01/01-introduction.html)"
transition: slide
...
# Welcome to DATASCI 385 <br> Experimental Methods! 🎉 {background-color="#1B3A6B"}
...
`r fa('github')` Course repository: <https://github.com/danilofreire/datasci385>

`r fa('globe')` Course website: <https://danilofreire.github.io/datasci385>

All course materials, including lectures, code, discussions, assignments, and project guidelines, are available on our [GitHub repository](https://github.com/danilofreire/datasci385)
...
- The teaching assistant for this course is Jooha Lee. You can reach out to him at <jooha.lee@emory.edu>

- Jooha will help with grading assignments throughout the course (under my supervision)
 
- We are here to help you! So feel free to ask questions during class, office hours, or via email 😃

## Office hours
### What for and what not
...
- What these sessions are [not]{.alert} meant for: 
    ...
    - Developing your coding or stats skills for you
:::
...
# What are randomised controlled trials? 🎲🧪 {background-color="#1B3A6B"}
...
- In its simplest form, an RCT consists of [a control group and a treatment group]{.alert}, with the treatment group randomly receiving the intervention and the control group not receiving it
...
# Causality 🔍🔗 {background-color="#1B3A6B"}
...
# Course overview and logistics `r emo::ji('open_book')` `r emo::ji('books')` `r emo::ji('computer')` {background-color="#1B3A6B"}
...
Guides: <https://danilofreire.github.io/datasci385/guides.html>
:::
...
::: {style="font-size: 28px;"}
- [Syllabus:]{.alert} Available on our [course repository](https://github.com/danilofreire/datasci385/blob/main/syllabus.pdf) and [website](https://danilofreire.github.io/datasci385/syllabus.html). The course is designed to be self-contained. The syllabus includes links to slides and code we will use in class, along with recommended readings, and problem sets. I will upload slides throughout the term as we progress
- [Schedule:]{.alert} Lectures are on Mondays and Wednesdays from 5:30 to 6:45 pm in the Psychology Building, Room 220
- [Office Hours:]{.alert} I'm available to meet you [at any time.]{.alert} Please reach out some time in advance and we can schedule a meeting
- [Materials:]{.alert}
    - Course repository: <https://github.com/danilofreire/datasci385>
    - Canvas
:::
...
# Thank you very much for your attention! 🙏🏻 <br><br> Have a great day! 😊 {background-color="#1B3A6B"}