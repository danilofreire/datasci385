...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Heterogeneous Effects](https://danilofreire.github.io/datasci385/lectures/lecture-18/18-hte.html)"
transition: slide
...
# Hello, everyone! 👋 <br> How are you today? {background-color="#1B3A6B"}
...
# Why look beyond the ATE? {background-color="#1B3A6B"}
...
# The fundamental problem of HTE inference {background-color="#1B3A6B"}
...
# Detecting heterogeneity: bounds & tests {background-color="#1B3A6B"}
...
# Treatment-by-Covariate Interactions (CATEs) 📊 {background-color="#1B3A6B"}
...
# Cautions with CATEs ⚠️ {background-color="#1B3A6B"}
...
# Treatment-by-Treatment Interactions (Factorial Designs) 🧪 {background-color="#1B3A6B"}
...
# Modelling HTE with regression 📈 {background-color="#1B3A6B"}
