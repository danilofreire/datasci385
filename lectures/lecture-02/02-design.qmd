...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Research Design](https://danilofreire.github.io/datasci385/lectures/lecture-02/02-design.html/)"
...
# Hello, everyone! 👋 <br> Nice to meet you again! 😊 {background-color="#1B3A6B"}
...
- All materials, including lectures, code, and assignments, are available online
  - Course website: <https://danilofreire.github.io/datasci385/>
  - GitHub repository: <https://github.com/danilofreire/datasci385>
- About me: Danilo Freire, VAP in the Department of Data and Decision Sciences
  - Email: <danilo.freire@emory.edu>
...
[![](figures/website.png)](#){data-modal-type="iframe" data-modal-url="https://danilofreire.github.io/datasci385/"}

Click on the image to access the course website! 🌐

<https://danilofreire.github.io/datasci385/>
:::
...
Lots of additional readings are included [in the syllabus](https://github.com/danilofreire/datasci385/blob/main/syllabus.pdf) 😊
:::
...
- [EGAP research design form](https://danilofreire.github.io/datasci385/design-form.html): A guide to help you think through the key components of your research design
...
# But first... <br><br> Let's do an experiment right now! 😄 {background-color="#1B3A6B"}
...
# Let's discuss the results! 📊 {background-color="#1B3A6B"}

# What makes a research question good? 🤔 {background-color="#1B3A6B"}
...
- There are a number of different types of questions that we may want to answer. In academia, they are often divided into two broad categories:
  ...
  - [Descriptive questions]{.alert}: Descriptions of a given phenomenon: e.g., “_how do teachers allocate their time during a school day?_”
...
- (Next sessions: more about what we mean by causality and how experiments give us leverage to make causal claims)
:::
...
- What theory could lead to this experimental design?
...
- Moreover, the underlying outcome concept [may even be under debate]{.alert} (e.g., democracy)
...
- In pairs or groups of three:
  ...
  - Generate hypotheses on potential heterogeneous effects 
  - Generate an expected effect size 
...
# Pre-registration and pre-analysis plans 📝 {background-color="#1B3A6B"}
...
- We all face [incentives to change our specifications]{.alert}, measurements, or even
...
- We will be using it in our course, and you can access it [here](https://egap.github.io/learningdays-resources/Exercises/design-form.html) or [on our website](https://danilofreire.github.io/datasci385/design-form.html)
...
|     motivation**  | about the results of this research? [1           |
|                   | paragraph]                                       |
...
|                   | [2-3 pieces]                                     |
+-------------------+--------------------------------------------------+
| 7. **Secondary    | i. What are the secondary parameter/estimands the|
|    hypotheses**   | research design seeks to estimate? What sign     |
...
|                   | placebo condition designed to control for?       |
+-------------------+--------------------------------------------------+
...
|                   | overlap?                                         |
+-------------------+--------------------------------------------------+
| 19. **Compliance**| i. What does it mean to "take" (comply with)     | 
|                   | the intervention?                                |
|                   | ii. If the intervention is a program, how much   |
|                   | does someone need to attend (showing up once?    |
...
|                   | forced to comply with the intervention?          |
...
|                   | measured?                                        |
|                   | ii. What additional covariates (if any) will you |
|                   | measure?                                         |
...
# The MIDA framework 📊 {background-color="#1B3A6B"}
...
- [Simulate it!]{.alert}
- Luckily, there is a package that does all the hard work for us: [DeclareDesign](https://declaredesign.org/)
...
:::{style="margin-top: 30px; font-size: 32px;"}
- Given a realisation of the data, generate an answer -- an estimate of the quantity of interest (inquiry)

- This is your [estimator or test]{.alert}:
  - Difference-in-means
  - $t$-test
  - Regression methods
  - etc

- Answer is an [estimate of the quantity of interest or $p$-value]{.alert} (inquiry/estimand/test)
:::

# Let's see an example: Two-arm trial {background-color="#1B3A6B"}
...
# Wrap-up 🤓 {background-color="#1B3A6B"}
...
# Thank you very much! 👏 <br> See you soon! 😊 {background-color="#1B3A6B"}