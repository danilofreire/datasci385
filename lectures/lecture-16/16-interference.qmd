...
- You think that [awaring a prize to students]{.alert} will help motivate them
...
- We need to [expand our potential outcomes notation]{.alert} to account for this...
:::
...
- In this case, the subject at location F can never manifest a $Y_{10}$ outcome because it can never be adjacent to a
treated unit 
...
- It becomes the ATE amongst villages that could express the potential outcomes $Y_{10}$ and $Y_{00}$ (no missingness)
:::
...
:::{style="margin-top: 20px; text-align: center;"}
| Village | A ($Y_{01}$) | B ($Y_{10}$) | C ($Y_{00}$) | D ($Y_{10}$) | F ($Y_{00}$) | Pr(assignment to control) | Pr(assignment to spillover) | Pr(assignment to treatment) |
|---|---|---|---|---|---|---|---|---|
...
- Eight media markets are randomly assigned to one of four conditions:
  ...
  - And two media markets air no ads at all
:::
