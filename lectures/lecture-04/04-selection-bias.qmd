...
:::{.columns}
:::{.column width=50%}
- [Selection bias]{.alert} occurs when the groups are systematically different, often before the treatment (but not exclusively!)
...
- [Example]{.alert}: Suppose you measure the IQ of 50 students
  ...
  - You calculate the [Standard Deviation (SD) = 15]
