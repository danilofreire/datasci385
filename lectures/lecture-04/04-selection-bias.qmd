...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Selection Bias](https://danilofreire.github.io/datasci385/lectures/lecture-04/04-selection-bias.html)"
transition: slide
...
# Hello, everyone! 👋 <br> Nice to see you all again! 😉 {background-color="#1B3A6B"}
...
# Different types of selection bias 🎯 {background-color="#1B3A6B"}
...
# Measuring variability 📏 {background-color="#1B3A6B"}
...
# Regression analysis of experiments 📊 {background-color="#1B3A6B"}
