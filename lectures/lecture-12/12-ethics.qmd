...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Ethics](https://danilofreire.github.io/datasci385/lectures/lecture-12/12-ethics.html)"
transition: slide
...
# Hello, everyone! <br> Nice to see you! 😉 {background-color="#1B3A6B"}
...
- Analysis methods:
  ...
  - [Extreme bounds analysis / Manski bounds]{.alert} (EBA): Evaluates sensitivity by assuming best/worst case scenarios
...
# A brief history of research ethics 📜 {background-color="#1B3A6B"}

## In the beginning...
### ...there was no ethical oversight!
...
- Examples of unethical research existed throughout history, but the [scale and inhumane nature]{.alert} of some events in the 20th century prompted change
:::
...
:::{.columns}
:::{.column width="50%"}
- The [Tuskegee Study of Untreated Syphilis]{.alert} was a clinical study conducted between 1932 and 1972 by the U.S. Public Health Service, the Centers for Disease Control and Prevention, and the Tuskegee Institute in Alabama
- The goal was to observe the natural progression of untreated syphilis in rural African Americans who thought they were receiving free health care from the U.S. government
- 399 men had syphilis, 201 did not, and [none were informed of their diagnosis or the study's true purpose]{.alert}
- The study was [terminated in 1972]{.alert} after its unethical nature was exposed (40 years later!)
...
- Participants did not receive treatment even after penicillin became the standard of care in 1947
- In 1997, President Bill Clinton [apologised on behalf of the U.S. government]{.alert} for the study
:::
...
:::{.columns}
:::{.column width="50%"}
- The [Belmont Report]{.alert} was written by the National Commission for the Protection of Human Subjects of Biomedical and Behavioural Research
...
- The report outlines [three fundamental ethical principles]{.alert} for research involving human subjects:
  ...
  - Beneficence
  - Justice
- These principles are the basis for the [Common Rule]{.alert}, which governs federally funded research in the U.S.
...
# Ethical considerations in experimental research 😇 {background-color="#1B3A6B"}
...
:::{.columns}
:::{.column width="50%"}
- [Anonymity means, by definition, that all identifying information about subjects is destroyed after the study]{.alert}; as it provides the greatest protection to those subjects
...
# Institutional Review Boards (IRBs) 🏛️ {background-color="#1B3A6B"}
...
- IRBs are [required for federally funded research]{.alert} in the U.S. and in many other countries
...
- The board may determine that your research can continue, but it is the board that decides this (not you)
- You are obliged to [inform the board]{.alert} about "adverse events" in the research
:::
...
## Ethical Review Committees Outside the U.S.
...
- Consider "equipoise" ([Freedman 1987](https://pubmed.ncbi.nlm.nih.gov/3600702/)): Genuine uncertainty about the best approach 
...
# Adaptive research design 🔄 {background-color="#1B3A6B"}
...
- But it requires that the [best solution be found quickly]{.alert} and that the [researchers are able to adapt]{.alert} to the new information
:::
...
- [Randomisation can promote justice]{.alert}, as it ensures:
  ...
  - Promotes procedural fairness: everyone has an equal chance and there is no favouritism
...
- [Avoid exclusion]{.alert} for convenience
  ...
  - Example: Accommodating participants without internet access
:::

:::{.column width="50%"}
- [Consider Heterogeneous Effects]{.alert}
  - Power the study to detect subgroup impacts
...
# Research staff ethics 🧑‍🔬 {background-color="#1B3A6B"}
...
- [Physical risks]{.alert}: Violence, accidents, health hazards
  - Example: Enumerators in high-crime areas
:::

:::{.column width="50%"}
- [Psychological risks]{.alert}: Emotional burden, secondary trauma
...
- [Debriefing and support]{.alert}
  ...
  - Counselling access for secondary trauma/burnout
...
- [Clear communication]{.alert}
  ...
  - Example: Workshops explaining randomisation ethics
...
# Community ethics 🏘️ {background-color="#1B3A6B"}
