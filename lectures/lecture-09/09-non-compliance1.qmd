...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Non-Compliance 1](https://danilofreire.github.io/datasci385/lectures/lecture-09/09-non-compliance1.html)"
transition: slide
...
# Group work 👥 {background-color="#1B3A6B"}
...
# Non-compliance 🤔 {background-color="#1B3A6B"}
...
- [This is the best approach]{.alert} 👍
- But first, some definitions and concepts... 🤓
:::

# New definitions and assumptions 🤓 {background-color="#1B3A6B"}
...
# CACE and IVs 🤓 {background-color="#1B3A6B"}
...
# Designs that anticipate non-compliance 🤓 {background-color="#1B3A6B"}
