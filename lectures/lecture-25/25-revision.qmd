...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Course Revision](https://danilofreire.github.io/datasci385/lectures/lecture-25/25-revision.html)"
transition: slide
...
# Welcome back! 🤓 <br> Course revision session 📚 {background-color="#1B3A6B"}
...
# Foundations 🏗️ {background-color="#1B3A6B"}
...
# Design Challenges & Solutions 🛠️ {background-color="#1B3A6B"}
...
# Advanced Methods & Applications 🔬 {background-color="#1B3A6B"}
...
# Discussions & Integration 🌍 {background-color="#1B3A6B"}
