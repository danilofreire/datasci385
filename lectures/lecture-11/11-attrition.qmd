...
- We can classify individuals into four types based on their response behaviour [(Lee 2009)](https://academic.oup.com/restud/article/76/3/1071/1590707):
  ...
  - [Never-reporters:]{.alert} $r_i(0) = 0$ and $r_i(1) = 0$. Regardless of treatment status, always attrite on the outcome
...
- While this new framework is helpful, it has the same issue we discussed in our previous class: [we cannot know know whether individuals are one type or another]{.alert} (more on this later!)
::: 
