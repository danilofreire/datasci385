...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Sensitive Topics](https://danilofreire.github.io/datasci385/lectures/lecture-22/22-survey2.html)"
transition: slide
...
# Notes about the group project {background-color="#1B3A6B"}
...
# List experiments 📋 {background-color="#1B3A6B"}
...
# Did hidden Trump voters exist? {background-color="#1B3A6B"}
...
# Do Russians support the war in Ukraine? {background-color="#1B3A6B"}
...
# Endorsement experiments {background-color="#1B3A6B"}
...
# Did political endorsement influence mass opinion during COVID-19? {background-color="#1B3A6B"}
...
# Randomised response techniques 🎲 {background-color="#1B3A6B"}
...
# Conjoint analysis {background-color="#1B3A6B"}
